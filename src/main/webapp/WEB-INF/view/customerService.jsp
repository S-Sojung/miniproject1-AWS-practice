                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="person-heading${loop.index}">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#person-collapse${loop.index}" aria-expanded="false" aria-controls="person-collapse${loop.index}">
                                    ${pFAQ.question}
                                </button>
                            </h2>
                            <div id="person-collapse${loop.index}" class="accordion-collapse collapse" aria-labelledby="person-heading${loop.index}"
                    ...
                    <div class="accordion mb-5" id="accordionExample2">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="company-heading${loop.index}">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#company-collapse${loop.index}" aria-expanded="false" aria-controls="company-collapse${loop.index}">
                                    ${cFAQ.question}
                                </button>
                            </h2>
                            <div id="company-collapse${loop.index}" class="accordion-collapse collapse" aria-labelledby="company-heading${loop.index}"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    ${cFAQ.answer}
                                </div>

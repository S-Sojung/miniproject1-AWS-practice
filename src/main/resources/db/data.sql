...
INSERT INTO person_info_tb(name,phone,address,birthday,created_at) 
                values('쌀', '01078335659','부산 부산진구 부전동 000-00', '2000-04-10 00:00:00', now());
INSERT INTO person_info_tb(name,phone,address,birthday,created_at) 
                values('코스', '01045129866','부산 부산진구 부전동 000-00', '1998-07-22 00:00:00', now());

INSERT INTO company_info_tb(logo, name, number, boss_name, address, manager_name, manager_phone,size,cyear, created_at) 
                values('/images/logo.png','이닛', '5758801632', '보스' ,'부산 부산진구 부전동 000-00', '이니티', '01054896789',50,2022, now());
INSERT INTO company_info_tb(logo, name, number, boss_name, address, manager_name, manager_phone, size,cyear,created_at)
                values('/images/kakao.jpg','카카오', '5641295342', '카카오사장', '부산 부산진구 부전동 000-00', '카카오', '01043651222',100,2010, now());
INSERT INTO company_info_tb(logo, name, number,  boss_name, address, manager_name, manager_phone, size,cyear,created_at) 
                values('/images/google.png','구글', '7482165982', '구글사장', '부산 부산진구 부전동 000-00', '구글', '01081659232',200,1998, now());

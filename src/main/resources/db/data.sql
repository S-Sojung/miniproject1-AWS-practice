...
INSERT INTO person_info_tb(p_name,p_phone,p_address,created_at) values('쌀', '01000000000','부산 부산진구 부전동 000-00', now());

INSERT INTO company_info_tb(c_name, c_number, c_address, c_manager_name,c_manager_phone, created_at) values('이닛', '00000000000','부산 부산진구 부전동 000-00','이니티', '01000000000',now());
